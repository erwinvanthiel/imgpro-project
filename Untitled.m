blackwhite = calculate(imread('images/bus.JPG'));
subplot(2,6,1);
imagesc(uint8(blackwhite));
%sc2
blackwhite = calculate(imread('images/14.JPG'));
subplot(2,6,2);
imagesc(uint8(blackwhite));

%sc3
blackwhite = calculate(imread('images/15.JPG'));
subplot(2,6,3);
imagesc(uint8(blackwhite));

%sc4
blackwhite = calculate(imread('images/16.JPG'));
subplot(2,6,4);
imagesc(uint8(blackwhite));

blackwhite = calculate(imread('images/17.JPG'));
subplot(2,6,5);
imagesc(uint8(blackwhite));
%sc2
